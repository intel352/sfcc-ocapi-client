...
// OrderSearchResult Document representing an order search result.
// swagger:model order_search_result
...
// Validate validates this order search result
func (m *OrderSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrderSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *OrderSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *OrderSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *OrderSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *OrderSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *OrderSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *OrderSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OrderSearchResult) UnmarshalBinary(b []byte) error {
