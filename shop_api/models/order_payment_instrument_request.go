...
// OrderPaymentInstrumentRequest Document representing an order payment instrument request.
// swagger:model order_payment_instrument_request
type OrderPaymentInstrumentRequest struct {
	...
	CreateCustomerPaymentInstrument bool `json:"create_customer_payment_instrument,omitempty"`
...
// Validate validates this order payment instrument request
func (m *OrderPaymentInstrumentRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrderPaymentInstrumentRequest) validateBankRoutingNumber(formats strfmt.Registry) error {
...
func (m *OrderPaymentInstrumentRequest) validateGiftCertificateCode(formats strfmt.Registry) error {
...
func (m *OrderPaymentInstrumentRequest) validatePaymentBankAccount(formats strfmt.Registry) error {
...
func (m *OrderPaymentInstrumentRequest) validatePaymentCard(formats strfmt.Registry) error {
...
func (m *OrderPaymentInstrumentRequest) validatePaymentMethodID(formats strfmt.Registry) error {
...
func (m *OrderPaymentInstrumentRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OrderPaymentInstrumentRequest) UnmarshalBinary(b []byte) error {
	var res OrderPaymentInstrumentRequest
