...
// OrderSearchRequest Document representing an order search request.
// swagger:model order_search_request
...
// Validate validates this order search request
func (m *OrderSearchRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrderSearchRequest) validateCount(formats strfmt.Registry) error {
...
func (m *OrderSearchRequest) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *OrderSearchRequest) validateQuery(formats strfmt.Registry) error {
...
func (m *OrderSearchRequest) validateSorts(formats strfmt.Registry) error {
...
func (m *OrderSearchRequest) validateStart(formats strfmt.Registry) error {
...
func (m *OrderSearchRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OrderSearchRequest) UnmarshalBinary(b []byte) error {
	var res OrderSearchRequest
