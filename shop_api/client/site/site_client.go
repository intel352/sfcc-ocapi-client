...
/*
GetSite Access site information, like site status and site content URLs.
*/
func (a *Client) GetSite(params *GetSiteParams, authInfo runtime.ClientAuthInfoWriter) error {
