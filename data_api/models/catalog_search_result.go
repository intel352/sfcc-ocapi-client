...
// CatalogSearchResult Document representing a catalog search result.
// swagger:model catalog_search_result
...
// Validate validates this catalog search result
func (m *CatalogSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CatalogSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CatalogSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CatalogSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CatalogSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CatalogSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CatalogSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CatalogSearchResult) UnmarshalBinary(b []byte) error {
