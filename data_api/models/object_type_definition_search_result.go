...
// ObjectTypeDefinitionSearchResult Document representing a systemobject search result.
// swagger:model object_type_definition_search_result
type ObjectTypeDefinitionSearchResult struct {
	...
	Hits []*ObjectTypeDefinition `json:"hits"`
...
// Validate validates this object type definition search result
func (m *ObjectTypeDefinitionSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ObjectTypeDefinitionSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *ObjectTypeDefinitionSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *ObjectTypeDefinitionSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *ObjectTypeDefinitionSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *ObjectTypeDefinitionSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *ObjectTypeDefinitionSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *ObjectTypeDefinitionSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ObjectTypeDefinitionSearchResult) UnmarshalBinary(b []byte) error {
	var res ObjectTypeDefinitionSearchResult
