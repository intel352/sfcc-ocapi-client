...
// SourceCodeGroupSearchResult Document representing a source code group search result.
// swagger:model source_code_group_search_result
type SourceCodeGroupSearchResult struct {
	...
	Hits []*SourceCodeGroup `json:"hits"`
...
// Validate validates this source code group search result
func (m *SourceCodeGroupSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SourceCodeGroupSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *SourceCodeGroupSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *SourceCodeGroupSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *SourceCodeGroupSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *SourceCodeGroupSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *SourceCodeGroupSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *SourceCodeGroupSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SourceCodeGroupSearchResult) UnmarshalBinary(b []byte) error {
	var res SourceCodeGroupSearchResult
