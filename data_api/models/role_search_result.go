...
// RoleSearchResult Document representing an access role search result.
// swagger:model role_search_result
...
// Validate validates this role search result
func (m *RoleSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RoleSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *RoleSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *RoleSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *RoleSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *RoleSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *RoleSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *RoleSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RoleSearchResult) UnmarshalBinary(b []byte) error {
	var res RoleSearchResult
