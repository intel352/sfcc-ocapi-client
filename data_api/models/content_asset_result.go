...
// ContentAssetResult Result document containing an array of content assets.
// swagger:model content_asset_result
...
// Validate validates this content asset result
func (m *ContentAssetResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ContentAssetResult) validateHits(formats strfmt.Registry) error {
...
func (m *ContentAssetResult) validateStart(formats strfmt.Registry) error {
...
func (m *ContentAssetResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ContentAssetResult) UnmarshalBinary(b []byte) error {
	var res ContentAssetResult
