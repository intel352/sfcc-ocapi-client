...
// CustomObjectSearchResult Document representing a custom object search result.
// swagger:model custom_object_search_result
type CustomObjectSearchResult struct {
...
// Validate validates this custom object search result
func (m *CustomObjectSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomObjectSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CustomObjectSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CustomObjectSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CustomObjectSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CustomObjectSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CustomObjectSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CustomObjectSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomObjectSearchResult) UnmarshalBinary(b []byte) error {
	var res CustomObjectSearchResult
