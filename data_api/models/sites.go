...
// Sites Document representing an unfiltered list of sites.
// swagger:model sites
type Sites struct {
...
func (m *Sites) validateData(formats strfmt.Registry) error {
...
func (m *Sites) validateStart(formats strfmt.Registry) error {
...
func (m *Sites) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Sites) UnmarshalBinary(b []byte) error {
	var res Sites
