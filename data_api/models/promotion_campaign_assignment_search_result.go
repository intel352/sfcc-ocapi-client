...
// PromotionCampaignAssignmentSearchResult Document representing a promotion campaign assignment search result.
// swagger:model promotion_campaign_assignment_search_result
type PromotionCampaignAssignmentSearchResult struct {
	...
	Hits []*PromotionCampaignAssignment `json:"hits"`
...
// Validate validates this promotion campaign assignment search result
func (m *PromotionCampaignAssignmentSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PromotionCampaignAssignmentSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *PromotionCampaignAssignmentSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *PromotionCampaignAssignmentSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *PromotionCampaignAssignmentSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *PromotionCampaignAssignmentSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *PromotionCampaignAssignmentSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *PromotionCampaignAssignmentSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PromotionCampaignAssignmentSearchResult) UnmarshalBinary(b []byte) error {
	var res PromotionCampaignAssignmentSearchResult
