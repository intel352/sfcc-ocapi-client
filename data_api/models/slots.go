...
// Slots Document representing an unfiltered list of slots.
// swagger:model slots
type Slots struct {
...
func (m *Slots) validateData(formats strfmt.Registry) error {
...
func (m *Slots) validateStart(formats strfmt.Registry) error {
