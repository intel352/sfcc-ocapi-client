...
// Stores Document representing an unfiltered list of stores.
...
func (m *Stores) validateData(formats strfmt.Registry) error {
...
func (m *Stores) validateStart(formats strfmt.Registry) error {
