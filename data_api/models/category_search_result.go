...
// CategorySearchResult Document representing a catalog search result.
// swagger:model category_search_result
...
// Validate validates this category search result
func (m *CategorySearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CategorySearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CategorySearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CategorySearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CategorySearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CategorySearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CategorySearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CategorySearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CategorySearchResult) UnmarshalBinary(b []byte) error {
