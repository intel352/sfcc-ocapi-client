...
// PreferenceValueSearchResult Document representing a preference value search result.
// swagger:model preference_value_search_result
type PreferenceValueSearchResult struct {
	...
	Hits []*PreferenceValue `json:"hits"`
...
// Validate validates this preference value search result
func (m *PreferenceValueSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PreferenceValueSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *PreferenceValueSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *PreferenceValueSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *PreferenceValueSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *PreferenceValueSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *PreferenceValueSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *PreferenceValueSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PreferenceValueSearchResult) UnmarshalBinary(b []byte) error {
	var res PreferenceValueSearchResult
