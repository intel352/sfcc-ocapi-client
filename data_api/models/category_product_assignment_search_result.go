...
// CategoryProductAssignmentSearchResult Document representing a product search result.
// swagger:model category_product_assignment_search_result
type CategoryProductAssignmentSearchResult struct {
	...
	Hits []*CategoryProductAssignment `json:"hits"`
...
// Validate validates this category product assignment search result
func (m *CategoryProductAssignmentSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CategoryProductAssignmentSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CategoryProductAssignmentSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CategoryProductAssignmentSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CategoryProductAssignmentSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CategoryProductAssignmentSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CategoryProductAssignmentSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CategoryProductAssignmentSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CategoryProductAssignmentSearchResult) UnmarshalBinary(b []byte) error {
	var res CategoryProductAssignmentSearchResult
