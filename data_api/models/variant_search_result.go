...
// VariantSearchResult Document that represents a search on certificates and keys.
// swagger:model variant_search_result
...
// Validate validates this variant search result
func (m *VariantSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VariantSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *VariantSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *VariantSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *VariantSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *VariantSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *VariantSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *VariantSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VariantSearchResult) UnmarshalBinary(b []byte) error {
	var res VariantSearchResult
