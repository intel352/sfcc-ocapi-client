...
// CustomerGroupSearchResult Document representing a customer group search result.
// swagger:model customer_group_search_result
type CustomerGroupSearchResult struct {
...
// Validate validates this customer group search result
func (m *CustomerGroupSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerGroupSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CustomerGroupSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CustomerGroupSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CustomerGroupSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CustomerGroupSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CustomerGroupSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CustomerGroupSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomerGroupSearchResult) UnmarshalBinary(b []byte) error {
	var res CustomerGroupSearchResult
