...
// ObjectAttributeDefinitionSearchResult Document representing an attributedefinition search result.
// swagger:model object_attribute_definition_search_result
type ObjectAttributeDefinitionSearchResult struct {
	...
	Hits []*ObjectAttributeDefinition `json:"hits"`
...
// Validate validates this object attribute definition search result
func (m *ObjectAttributeDefinitionSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ObjectAttributeDefinitionSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *ObjectAttributeDefinitionSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *ObjectAttributeDefinitionSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *ObjectAttributeDefinitionSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *ObjectAttributeDefinitionSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *ObjectAttributeDefinitionSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *ObjectAttributeDefinitionSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ObjectAttributeDefinitionSearchResult) UnmarshalBinary(b []byte) error {
	var res ObjectAttributeDefinitionSearchResult
