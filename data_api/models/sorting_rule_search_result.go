...
// SortingRuleSearchResult Document representing a source code group search result.
// swagger:model sorting_rule_search_result
type SortingRuleSearchResult struct {
...
// Validate validates this sorting rule search result
func (m *SortingRuleSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SortingRuleSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *SortingRuleSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *SortingRuleSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *SortingRuleSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *SortingRuleSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *SortingRuleSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *SortingRuleSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SortingRuleSearchResult) UnmarshalBinary(b []byte) error {
	var res SortingRuleSearchResult
