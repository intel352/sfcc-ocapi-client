...
// CampaignSearchResult Document representing a campaign search result.
// swagger:model campaign_search_result
...
// Validate validates this campaign search result
func (m *CampaignSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CampaignSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CampaignSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CampaignSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CampaignSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CampaignSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CampaignSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CampaignSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CampaignSearchResult) UnmarshalBinary(b []byte) error {
	var res CampaignSearchResult
