...
// SlotConfigurationAssignmentInformation slot configuration assignment information
// swagger:model slot_configuration_assignment_information
type SlotConfigurationAssignmentInformation struct {
	...
	ActiveAbtestAssignments []*SlotConfigurationAbtestGroupAssignment `json:"active_abtest_assignments"`

	// A list of currently active campaigns this is assigned to.
	ActiveCampaignAssignments []*SlotConfigurationCampaignAssignment `json:"active_campaign_assignments"`
	...
	UpcomingAbtestAssignments []*SlotConfigurationAbtestGroupAssignment `json:"upcoming_abtest_assignments"`

	// A list of upcoming campaigns this is assigned to.
	UpcomingCampaignAssignments []*SlotConfigurationCampaignAssignment `json:"upcoming_campaign_assignments"`
}

// Validate validates this slot configuration assignment information
func (m *SlotConfigurationAssignmentInformation) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SlotConfigurationAssignmentInformation) validateActiveAbtestAssignments(formats strfmt.Registry) error {
...
func (m *SlotConfigurationAssignmentInformation) validateActiveCampaignAssignments(formats strfmt.Registry) error {
...
func (m *SlotConfigurationAssignmentInformation) validateEndDate(formats strfmt.Registry) error {
...
func (m *SlotConfigurationAssignmentInformation) validateSchedule(formats strfmt.Registry) error {
...
var slotConfigurationAssignmentInformationTypeScheduleTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		slotConfigurationAssignmentInformationTypeScheduleTypePropEnum = append(slotConfigurationAssignmentInformationTypeScheduleTypePropEnum, v)
	}
}

const (

	// SlotConfigurationAssignmentInformationScheduleTypeNone captures enum value "none"
	SlotConfigurationAssignmentInformationScheduleTypeNone string = "none"

	// SlotConfigurationAssignmentInformationScheduleTypeCampaign captures enum value "campaign"
	SlotConfigurationAssignmentInformationScheduleTypeCampaign string = "campaign"

	// SlotConfigurationAssignmentInformationScheduleTypeAbtest captures enum value "abtest"
	SlotConfigurationAssignmentInformationScheduleTypeAbtest string = "abtest"

	// SlotConfigurationAssignmentInformationScheduleTypeMultiple captures enum value "multiple"
	SlotConfigurationAssignmentInformationScheduleTypeMultiple string = "multiple"
)

// prop value enum
func (m *SlotConfigurationAssignmentInformation) validateScheduleTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, slotConfigurationAssignmentInformationTypeScheduleTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *SlotConfigurationAssignmentInformation) validateScheduleType(formats strfmt.Registry) error {
...
func (m *SlotConfigurationAssignmentInformation) validateStartDate(formats strfmt.Registry) error {
...
func (m *SlotConfigurationAssignmentInformation) validateUpcomingAbtestAssignments(formats strfmt.Registry) error {
...
func (m *SlotConfigurationAssignmentInformation) validateUpcomingCampaignAssignments(formats strfmt.Registry) error {
...
func (m *SlotConfigurationAssignmentInformation) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SlotConfigurationAssignmentInformation) UnmarshalBinary(b []byte) error {
	var res SlotConfigurationAssignmentInformation
