...
// PromotionSearchResult Document representing a promotion search result.
// swagger:model promotion_search_result
...
// Validate validates this promotion search result
func (m *PromotionSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PromotionSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *PromotionSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *PromotionSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *PromotionSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *PromotionSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *PromotionSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *PromotionSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PromotionSearchResult) UnmarshalBinary(b []byte) error {
	var res PromotionSearchResult
