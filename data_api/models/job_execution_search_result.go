...
// JobExecutionSearchResult Document representing a job search result.
// swagger:model job_execution_search_result
type JobExecutionSearchResult struct {
...
// Validate validates this job execution search result
func (m *JobExecutionSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JobExecutionSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *JobExecutionSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *JobExecutionSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *JobExecutionSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *JobExecutionSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *JobExecutionSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *JobExecutionSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *JobExecutionSearchResult) UnmarshalBinary(b []byte) error {
	var res JobExecutionSearchResult
