...
// Categories Document representing an unfiltered list of categories.
...
func (m *Categories) validateData(formats strfmt.Registry) error {
...
func (m *Categories) validateStart(formats strfmt.Registry) error {
