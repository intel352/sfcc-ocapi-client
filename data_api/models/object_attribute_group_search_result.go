...
// ObjectAttributeGroupSearchResult Document representing a attributegroup search result.
// swagger:model object_attribute_group_search_result
type ObjectAttributeGroupSearchResult struct {
	...
	Hits []*ObjectAttributeGroup `json:"hits"`
...
// Validate validates this object attribute group search result
func (m *ObjectAttributeGroupSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ObjectAttributeGroupSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *ObjectAttributeGroupSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *ObjectAttributeGroupSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *ObjectAttributeGroupSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *ObjectAttributeGroupSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *ObjectAttributeGroupSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *ObjectAttributeGroupSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ObjectAttributeGroupSearchResult) UnmarshalBinary(b []byte) error {
	var res ObjectAttributeGroupSearchResult
