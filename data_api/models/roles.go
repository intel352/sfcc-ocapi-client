...
// Roles Document representing a list of access roles.
// swagger:model roles
type Roles struct {
...
func (m *Roles) validateData(formats strfmt.Registry) error {
...
func (m *Roles) validateStart(formats strfmt.Registry) error {
