...
// UserSearchResult Document representing an user search result.
// swagger:model user_search_result
...
// Validate validates this user search result
func (m *UserSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UserSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *UserSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *UserSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *UserSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *UserSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *UserSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *UserSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UserSearchResult) UnmarshalBinary(b []byte) error {
