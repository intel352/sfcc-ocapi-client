...
// SlotConfigurationCampaignAssignmentSearchResult slot configuration campaign assignment search result
// swagger:model slot_configuration_campaign_assignment_search_result
type SlotConfigurationCampaignAssignmentSearchResult struct {
	...
	Hits []*SlotConfigurationCampaignAssignment `json:"hits"`
...
// Validate validates this slot configuration campaign assignment search result
func (m *SlotConfigurationCampaignAssignmentSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SlotConfigurationCampaignAssignmentSearchResult) UnmarshalBinary(b []byte) error {
	var res SlotConfigurationCampaignAssignmentSearchResult
