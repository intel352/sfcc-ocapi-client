...
// InventoryListSearchResult Document representing a inventorylist search result.
// swagger:model inventory_list_search_result
type InventoryListSearchResult struct {
...
// Validate validates this inventory list search result
func (m *InventoryListSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InventoryListSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *InventoryListSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *InventoryListSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *InventoryListSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *InventoryListSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *InventoryListSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *InventoryListSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InventoryListSearchResult) UnmarshalBinary(b []byte) error {
	var res InventoryListSearchResult
