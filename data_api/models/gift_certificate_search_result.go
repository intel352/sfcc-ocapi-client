...
// GiftCertificateSearchResult Document representing a gift certificate search result.
// swagger:model gift_certificate_search_result
type GiftCertificateSearchResult struct {
	...
	Hits []*GiftCertificate `json:"hits"`
...
// Validate validates this gift certificate search result
func (m *GiftCertificateSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GiftCertificateSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *GiftCertificateSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *GiftCertificateSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *GiftCertificateSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *GiftCertificateSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *GiftCertificateSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *GiftCertificateSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GiftCertificateSearchResult) UnmarshalBinary(b []byte) error {
	var res GiftCertificateSearchResult
