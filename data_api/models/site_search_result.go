...
// SiteSearchResult Document representing a site search result.
// swagger:model site_search_result
...
// Validate validates this site search result
func (m *SiteSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SiteSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *SiteSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *SiteSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *SiteSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *SiteSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *SiteSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *SiteSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SiteSearchResult) UnmarshalBinary(b []byte) error {
	var res SiteSearchResult
