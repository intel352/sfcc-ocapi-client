...
// CustomerSearchResult Document representing a customer search result.
// swagger:model customer_search_result
type CustomerSearchResult struct {
	...
	Hits []*CustomerSearchHit `json:"hits"`
...
// Validate validates this customer search result
func (m *CustomerSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CustomerSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CustomerSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CustomerSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CustomerSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CustomerSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CustomerSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomerSearchResult) UnmarshalBinary(b []byte) error {
	var res CustomerSearchResult
