...
// CouponRedemptionSearchResult The result of the coupon redemption search
// swagger:model coupon_redemption_search_result
type CouponRedemptionSearchResult struct {
	...
	Hits []*CouponRedemption `json:"hits"`
...
// Validate validates this coupon redemption search result
func (m *CouponRedemptionSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CouponRedemptionSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CouponRedemptionSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CouponRedemptionSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CouponRedemptionSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CouponRedemptionSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CouponRedemptionSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CouponRedemptionSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CouponRedemptionSearchResult) UnmarshalBinary(b []byte) error {
	var res CouponRedemptionSearchResult
