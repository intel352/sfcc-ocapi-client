...
// CustomerGroupMemberSearchResult Document representing a customer group member search result.
// swagger:model customer_group_member_search_result
type CustomerGroupMemberSearchResult struct {
	...
	Hits []*CustomerGroupMember `json:"hits"`
...
// Validate validates this customer group member search result
func (m *CustomerGroupMemberSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerGroupMemberSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CustomerGroupMemberSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CustomerGroupMemberSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CustomerGroupMemberSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CustomerGroupMemberSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CustomerGroupMemberSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CustomerGroupMemberSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CustomerGroupMemberSearchResult) UnmarshalBinary(b []byte) error {
	var res CustomerGroupMemberSearchResult
