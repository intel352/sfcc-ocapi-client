...
// Variants Document representing an unfiltered list of variants.
...
func (m *Variants) validateData(formats strfmt.Registry) error {
...
func (m *Variants) validateStart(formats strfmt.Registry) error {
