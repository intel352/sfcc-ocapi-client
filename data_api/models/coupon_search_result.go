...
// CouponSearchResult Document representing a coupon search result.
// swagger:model coupon_search_result
...
// Validate validates this coupon search result
func (m *CouponSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CouponSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *CouponSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *CouponSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *CouponSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *CouponSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *CouponSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *CouponSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CouponSearchResult) UnmarshalBinary(b []byte) error {
	var res CouponSearchResult
