...
// SlotConfigurationSearchResult Document representing a slot configuration search result.
// swagger:model slot_configuration_search_result
type SlotConfigurationSearchResult struct {
	...
	Hits []*SlotConfiguration `json:"hits"`
...
// Validate validates this slot configuration search result
func (m *SlotConfigurationSearchResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SlotConfigurationSearchResult) validateDbStartRecord(formats strfmt.Registry) error {
...
func (m *SlotConfigurationSearchResult) validateHits(formats strfmt.Registry) error {
...
func (m *SlotConfigurationSearchResult) validateNext(formats strfmt.Registry) error {
...
func (m *SlotConfigurationSearchResult) validatePrevious(formats strfmt.Registry) error {
...
func (m *SlotConfigurationSearchResult) validateSorts(formats strfmt.Registry) error {
...
func (m *SlotConfigurationSearchResult) validateStart(formats strfmt.Registry) error {
...
func (m *SlotConfigurationSearchResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SlotConfigurationSearchResult) UnmarshalBinary(b []byte) error {
	var res SlotConfigurationSearchResult
