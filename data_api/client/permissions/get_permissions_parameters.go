...
type GetPermissionsParams struct {
	...
	/*Expand
	  The permission expand. A comma separated list with the allowed values (bm, csc).
...
// WithExpand adds the expand to the get permissions params
func (o *GetPermissionsParams) WithExpand(expand []string) *GetPermissionsParams {
	o.SetExpand(expand)
	return o
}

// SetExpand adds the expand to the get permissions params
func (o *GetPermissionsParams) SetExpand(expand []string) {
	o.Expand = expand
}
