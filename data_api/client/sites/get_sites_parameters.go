...
// WithCount adds the count to the get sites params
func (o *GetSitesParams) WithCount(count *int32) *GetSitesParams {
	o.SetCount(count)
	return o
}

// SetCount adds the count to the get sites params
func (o *GetSitesParams) SetCount(count *int32) {
	o.Count = count
}

// WithSelect adds the selectVar to the get sites params
func (o *GetSitesParams) WithSelect(selectVar *string) *GetSitesParams {
	o.SetSelect(selectVar)
	return o
}

// SetSelect adds the select to the get sites params
func (o *GetSitesParams) SetSelect(selectVar *string) {
	o.Select = selectVar
}

// WithStart adds the start to the get sites params
func (o *GetSitesParams) WithStart(start *int32) *GetSitesParams {
	o.SetStart(start)
	return o
}

// SetStart adds the start to the get sites params
func (o *GetSitesParams) SetStart(start *int32) {
	o.Start = start
}
