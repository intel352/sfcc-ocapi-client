...
// WithExpand adds the expand to the get roles by ID params
func (o *GetRolesByIDParams) WithExpand(expand []string) *GetRolesByIDParams {
	o.SetExpand(expand)
	return o
}

// SetExpand adds the expand to the get roles by ID params
func (o *GetRolesByIDParams) SetExpand(expand []string) {
	o.Expand = expand
}

// WithID adds the id to the get roles by ID params
func (o *GetRolesByIDParams) WithID(id string) *GetRolesByIDParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get roles by ID params
func (o *GetRolesByIDParams) SetID(id string) {
	o.ID = id
}
