...
// WithSiteID adds the siteID to the get products by ID params
func (o *GetProductsByIDParams) WithSiteID(siteID *string) *GetProductsByIDParams {
	o.SetSiteID(siteID)
	return o
}

// SetSiteID adds the siteId to the get products by ID params
func (o *GetProductsByIDParams) SetSiteID(siteID *string) {
	o.SiteID = siteID
}
